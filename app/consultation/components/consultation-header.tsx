      ...
      <div className="container flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          >
            ...
            <span className="hidden sm:inline">{t('consultation.header.back')}</span>
            <span className="sm:hidden">{t('consultation.header.backShort')}</span>
          </Button>
        </div>
        ...
        <div className="flex items-center gap-2 lg:gap-4">
          <div className="flex items-center gap-2 text-xs lg:text-sm text-muted-foreground">
            ...
            <span className="hidden sm:inline">{new Date().toLocaleDateString(language === 'es' ? 'es-ES' : 'en-US')}</span>
          </div>
        </div>
      </div>
    </header>
