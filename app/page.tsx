...
// Importing icons from lucide-react for use in various sections
import {
  Calendar,
  Phone,
  Mail,
...
export default function HomePage() {
  ...
  const services = [
    { title: t('services.general.title'), description: t('services.general.description'), icon: Stethoscope },
    { title: t('services.cardiology.title'), description: t('services.cardiology.description'), icon: Heart },
    { title: t('services.preventive.title'), description: t('services.preventive.description'), icon: Shield },
    { title: t('services.emergency.title'), description: t('services.emergency.description'), icon: Award },
  ]
        ...
        <div className="container px-4">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-primary mb-4 lg:mb-6">
                {t('hero.title')}
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                {/* Secondary CTA */}
                <Button size="lg" variant="outline" className="border-primary text-primary hover:bg-main-50 bg-transparent w-full sm:w-auto">
        ...
        <div className="container px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {newsArticles.map((article, index) => (
              <Card key={index} className="border-main-200 dark:border-main-800 hover:shadow-lg transition-shadow">
                <CardHeader>
                  {/* Badge for author and date */}
                  <div className="flex items-center justify-between mb-2">
                    <Badge variant="secondary" className="bg-main-100 text-primary dark:bg-main-900 dark:text-main-400">
                      {article.author}
                    </Badge>
                ...
                <CardFooter>
                  <Button variant="outline" size="sm" className="border-primary text-primary hover:bg-main-50 dark:border-main-400 dark:text-main-400 bg-transparent">
      ...
      <section id="contact" className="py-16 bg-main-50 dark:bg-main-950/20 relative">
        ...
        <div className="container px-4 relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground dark:text-muted-foreground max-w-2xl mx-auto">{t('contact.subtitle')}</p>
          </div>
