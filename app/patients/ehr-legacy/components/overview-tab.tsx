        ...
        <CardContent>
          {patientData.insurance ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{patientData.insurance.groupNumber || 'No especificado'}</span>
                </div>
              </div>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {patientData.insurance.expirationDate 
            ...
            <div className="text-center py-8 text-muted-foreground">
              <p>Información de seguro no disponible</p>
              <p className="text-xs mt-2">La información de seguro se puede agregar desde el módulo de facturación</p>
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <CardContent>
          {patientData.vitalSigns && patientData.vitalSigns.length > 0 ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-xs mt-2">Los signos vitales se registrarán durante las consultas</p>
            </div>
          )}
        </CardContent>
      </Card>
